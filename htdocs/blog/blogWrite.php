    ...
    <main id="main">
       <section id="blogWrite">
            ...
            <div class="write__inner container">
                <!-- 사진 넣어주기 enctype="multipart/form-data"-->
                <form action="blogWriteSave.php" name="blogWrite" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div>
                            ...
                            <input type="text" name="blogTitle" id="blogTitle" placeholder="제목을 넣어주세요." requierd>
                        </div>
                        <div>
                            <label for="blogContents">내용</label>
                            <textarea name="blogContents" id="blogContents" placeholder="내용을 넣어주세요." requierd></textarea>
                        </div>
                        <div>
